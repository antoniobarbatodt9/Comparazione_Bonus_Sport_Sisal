...
#### 9.3.1 Produzione (2026-09-14, dopo approvazione degli storyboard)
Nessun job avviato, **0 crediti**, nessun trasferimento aggiuntivo: il render 2× del 1920×1080 usa lo stesso file 1920×1080 (round-trip 2× → 1× dopo il Lanczos, vedi `adaptations/horizontal_family/family_system/background_strategy.md`). Audio: profilo `horizontal` di `make_audio.py` sulla stessa clip stadio `9d228081…`.
