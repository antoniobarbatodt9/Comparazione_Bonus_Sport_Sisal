...
| 300x250 | 0.58 MB | 3.33 MB | **0.50 MB** (CRF 12) | 0.34 MB | **1.91 MB** (25 fps) | 77 KB |
| 336x280 | 0.67 MB | 3.45 MB | **0.58 MB** (CRF 12) | 0.42 MB | **2.30 MB** (25 fps) | 92 KB |

### Varianti ad alta densità (2×) dei rettangoli — revisione nitidezza 2026-09-14

Richiesta del cliente: i rettangoli aperti sul PC risultavano poco nitidi. Causa: 300×250 e 336×280 sono i formati più piccoli della famiglia e un player desktop li ingrandisce ≈ 3×; la resa nativa era identica a quella delle verticali (PSNR 30,9 dB vs 31,0 dB a CRF 17, stessa nitidezza misurata sui testi). Intervento, entro gli stessi limiti di peso: **WEB nativo a CRF 12** (da 17) e **varianti a risoluzione doppia** (stessa animazione, stessi frame 2× già renderizzati, mostrate nello slot 300×250 / 336×280 come asset HiDPI: nitide anche ingrandite).

| Size | Risoluzione file | MASTER 2x (CRF 12) | WEB 2x (AAC 128k, ≤ 3,5 MB) | WEB 2x MUTO | GIF (≤ 3,5 MB) | ENDFRAME 2x |
|---|---|---|---|---|---|---|
| 300x250 | 600x500 | 2.02 MB | **1.94 MB** (CRF 12) | 1.78 MB | **3.31 MB** (600x500 @ 8 fps) | 276 KB |
| 336x280 | 672x560 | 2.54 MB | **2.46 MB** (CRF 12) | 2.30 MB | **3.08 MB** (504x420 @ 12.5 fps) | 339 KB |
- Le GIF a risoluzione doppia stanno in 3,5 MB solo a 8 fps (300×250: 600×500); per il 336×280 la GIF 672×560 pesa 4,08 MB anche a 8 fps, quindi la GIF ad alta densità è a **1,5× (504×420, 12,5 fps, 3,08 MB)**. Le GIF restano file di controllo: per la qualità valgono gli MP4.
- Confronto visivo (ingrandimento da player simulato): `11_qc/decodificati_horizontal/confronto_nitidezza_300x250.jpg`.
...
- Rettangoli: WEB.mp4 nativo a CRF 12 (0,50 / 0,58 MB; prima consegna a CRF 17: 0,33 / 0,37 MB), GIF a 25 fps piena (1,91 / 2,30 MB); varianti 2× sopra.
...
- ✅ Web MP4 MUTO: 0.34 MB (limite 3,5 MB) · durata 00:00:10.00 · audio no (atteso no)
- ✅ GIF di controllo: 1.91 MB (limite 3,5 MB) · durata 00:00:10.00 · audio no (atteso no)
- ✅ Audio (web): loudness integrata -20.1 LUFS (target −20 ±1) · true peak -5.8 dBTP (≤ −1)
- ✅ Coda audio: ultimo suono sopra −60 dB a 9.93 s (≤ 9,95 s)
- ✅ Nessuna voce: bed = stessa clip stadio Higgsfield del master (whisper base + VAD: 0 segmenti di parlato) + SFX procedurali numpy; nessun modello TTS/voce invocato
- ✅ Fascia disclaimer nei fotogrammi decodificati (web, 10 campioni): deviazione max 3.0 (≤ 6)
- ✅ Fascia disclaimer nei fotogrammi decodificati (gif, 10 campioni): deviazione max 2.0 (≤ 6)
- ✅ End frame decodificato (web): luminanza cifre 255€ (p90) 254 vs fondo card 28 (≥ 40 di differenza)
- ✅ End frame decodificato (gif): luminanza cifre 255€ (p90) 255 vs fondo card 29 (≥ 40 di differenza)
- ✅ Web MP4 2x: 1.94 MB (limite 3,5 MB) · 600×500 (atteso 600×500) · durata 00:00:10.00 · audio sì (atteso sì)
- ✅ Fascia disclaimer nei fotogrammi decodificati (Web MP4 2x, 10 campioni): deviazione max 3.0 (≤ 6)
- ✅ GIF 2x: 3.31 MB (limite 3,5 MB) · 600×500 (atteso 600×500) · durata 00:00:10.01 · audio no (atteso no)
- ✅ Fascia disclaimer nei fotogrammi decodificati (GIF 2x, 10 campioni): deviazione max 1.0 (≤ 6)
- ✅ Web MP4 2x: PSNR vs frame sorgente 2x a t 9,0 s = 38.5 dB (≥ 36)
...
- ✅ Valori nel template esattamente come da brief, 2 occorrenze ciascuno (hero + card): {'5.200€': 2, '1.000€': 2, '255€': 2} · testi vietati: nessuno
- ✅ Master MP4: 0.67 MB · durata 00:00:10.00 · audio sì (atteso sì)
- ✅ Web MP4: 0.58 MB (limite 3,5 MB) · durata 00:00:10.00 · audio sì (atteso sì)
- ✅ Web MP4 MUTO: 0.42 MB (limite 3,5 MB) · durata 00:00:10.00 · audio no (atteso no)
- ✅ GIF di controllo: 2.30 MB (limite 3,5 MB) · durata 00:00:10.00 · audio no (atteso no)
- ✅ Audio (web): loudness integrata -20.1 LUFS (target −20 ±1) · true peak -5.8 dBTP (≤ −1)
- ✅ Coda audio: ultimo suono sopra −60 dB a 9.93 s (≤ 9,95 s)
- ✅ Nessuna voce: bed = stessa clip stadio Higgsfield del master (whisper base + VAD: 0 segmenti di parlato) + SFX procedurali numpy; nessun modello TTS/voce invocato
...
- ✅ End frame decodificato (web): luminanza cifre 255€ (p90) 253 vs fondo card 28 (≥ 40 di differenza)
- ✅ End frame decodificato (gif): luminanza cifre 255€ (p90) 255 vs fondo card 29 (≥ 40 di differenza)
- ✅ Web MP4 2x: 2.46 MB (limite 3,5 MB) · 672×560 (atteso 672×560) · durata 00:00:10.00 · audio sì (atteso sì)
- ✅ Fascia disclaimer nei fotogrammi decodificati (Web MP4 2x, 10 campioni): deviazione max 3.0 (≤ 6)
- ❌ GIF 2x: 3.08 MB (limite 3,5 MB) · 504×420 (atteso 672×560) · durata 00:00:10.00 · audio no (atteso no)
- ❌ Fascia disclaimer nei fotogrammi decodificati (GIF 2x, 10 campioni): deviazione max 26.0 (≤ 6)
- ✅ Web MP4 2x: PSNR vs frame sorgente 2x a t 9,0 s = 39.3 dB (≥ 36)

- **ESITO COMPLESSIVO 336x280: CONTROLLI FALLITI, vedi sopra**
...
- ✅ Web MP4 2x: 2.46 MB (limite 3,5 MB) · 672×560 (atteso 672×560) · durata 00:00:10.00 · audio sì (atteso sì)
- ✅ Fascia disclaimer nei fotogrammi decodificati (Web MP4 2x, 10 campioni): deviazione max 3.0 (≤ 6)
- ✅ GIF 2x: 3.08 MB (limite 3,5 MB) · 504×420 (atteso 672×560, ammesso 1,5x) · durata 00:00:10.00 · audio no (atteso no)
- ✅ Fascia disclaimer nei fotogrammi decodificati (GIF 2x, 10 campioni): deviazione max 1.0 (≤ 6)
- ✅ Web MP4 2x: PSNR vs frame sorgente 2x a t 9,0 s = 39.3 dB (≥ 36)
